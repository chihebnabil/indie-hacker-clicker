        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-gradient-to-br from-slate-900/30 via-slate-800/20 to-slate-900/30">
            ...
            <div className="flex-none flex bg-slate-900/50 backdrop-blur-xl border-b border-white/10 shadow-lg">
                <button
                    ...
                    className={`relative flex-1 min-w-fit px-4 py-3 font-bold transition-all duration-300 ${selectedTab === 'buildings'
                ...
                <button
                    ...
                    className={`relative flex-1 min-w-fit px-4 py-3 font-bold transition-all duration-300 ${selectedTab === 'upgrades'
                ...
                <button
                    ...
                    className={`relative flex-1 min-w-fit px-4 py-3 font-bold transition-all duration-300 ${selectedTab === 'challenges'
                ...
                <button
                    ...
                    className={`relative flex-1 min-w-fit px-4 py-3 font-bold transition-all duration-300 ${selectedTab === 'achievements'
                ...
                <button
                    ...
                    className={`relative flex-1 min-w-fit px-4 py-3 font-bold transition-all duration-300 ${selectedTab === 'prestige'
